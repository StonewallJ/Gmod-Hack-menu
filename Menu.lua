...
button:SetSize(100,30)
button:SetText("Chat Spam")
button.DoClick = function (button)
 RunConsoleCommand  ("say" ,"DOGE  IS  MLG BRUH!!!!!") 
  RunConsoleCommand  ("say" ,"DOGE  IS  MLG BRUH!!!!!") 
...
local button = vgui.Create("DButton" ,frame)
button:SetPos(200,710)
button:SetSize(100,30)
button:SetText("Ultra  Server  Crash")
button.DoClick = function(button)
	for i=0, 1500 do
		RunConsoleCommand("gm_spawn",  "models/Combine_Helicopter.mdl")
	end
end

local button = vgui.Create("DButton" ,frame)
button:SetPos(450,100)
button:SetSize(100,30)
button:SetText("First  Person")
button.DoClick = function (button) RunConsoleCommand  ("firstperson") end

local button = vgui.Create("DButton" ,frame)
button:SetPos(450,140)
button:SetSize(100,30)
button:SetText("Thirdperson")
button.DoClick = function (button) RunConsoleCommand  ("thirdperson") end

local button = vgui.Create("DButton" ,frame)
button:SetPos(450,180)
button:SetSize(100,30)
button:SetText("No  Smoke")
button.DoClick = function (button) RunConsoleCommand  ("r_drawparticles", "0") end

local button = vgui.Create("DButton" ,frame)
button:SetPos(450,220)
button:SetSize(100,30)
button:SetText("Draw a red line")
button.DoClick = function (button) RunConsoleCommand  ("r_visualizetraces", "1") end

local button = vgui.Create("DButton" ,frame)
button:SetPos(450,260)
button:SetSize(100,30)
button:SetText("No  Fog")
button.DoClick = function (button) RunConsoleCommand  ("fog_enable", "0") end

local button = vgui.Create("DButton" ,frame)
button:SetPos(450,300)
button:SetSize(100,30)
button:SetText("Top view")
button.DoClick = function (button) RunConsoleCommand  ("cl_leveloverview", "2") end

local button = vgui.Create("DButton" ,frame)
button:SetPos(450,340)
button:SetSize(100,30)
button:SetText("Wireframe hack")
button.DoClick = function (button) RunConsoleCommand  ("perfui") end

local button = vgui.Create("DButton" ,frame)
button:SetPos(450,380)
button:SetSize(100,30)
button:SetText("Enable Smoke")
button.DoClick = function (button) RunConsoleCommand  ("r_drawparticles", "1") end

local button = vgui.Create("DButton" ,frame)
button:SetPos(450,420)
button:SetSize(100,30)
button:SetText("Remove red line")
button.DoClick = function (button) RunConsoleCommand  ("r_visualizetraces", "0") end

local button = vgui.Create("DButton" ,frame)
button:SetPos(450,460)
button:SetSize(100,30)
button:SetText("Enable Fog")
button.DoClick = function (button) RunConsoleCommand  ("fog_enable", "1") end

local button = vgui.Create("DButton" ,frame)
button:SetPos(450,500)
button:SetSize(100,30)
button:SetText("Reset View")
button.DoClick = function (button) RunConsoleCommand  ("cl_leveloverview", "0") end

local button = vgui.Create("DButton" ,frame)
button:SetPos(450,540)
button:SetSize(100,30)
...
local button = vgui.Create("DButton" ,frame)
button:SetPos(450,580)
button:SetSize(100,30)
button:SetText("Doge Preset")
button.DoClick = function()
RunConsoleCommand("bunnyhop_mike",  "1")
RunConsoleCommand("mike_nospread", "1")
RunConsoleCommand("mike_recoil", "1")
RunConsoleCommand("mike_aimbot", "1")
RunConsoleCommand("crosshair_mike", "1")
RunConsoleCommand("mike_snapon", "1")
RunConsoleCommand("mike_spectator", "1")
RunConsoleCommand("mike_rainbow", "1")
RunConsoleCommand("mike_box", "1")
RunConsoleCommand("mike_espcheap", "1")
end
...
local DLabel = vgui.Create( "DLabel", frame )
DLabel:SetPos( 450, 30 )
DLabel:SetText( "sv_cheats 1 Hacks" )
DLabel:SizeToContents()

local DLabel = vgui.Create( "DLabel", frame )
DLabel:SetPos( 350, 60 )
DLabel:SetText( "You  will  need  cvar 3  to  bypass  sv_cheats  1" )
DLabel:SizeToContents()
...
if v:GetObserverTarget( ) == LocalPlayer() then
	local h = ScrH() / 2
	local w = ScrW() / 2
	draw.SimpleTextOutlined( "Your  being Spectated", "DermaLarge", w - 39, h / 6, Color( 0, 255, 255 ), 1, 1, 1, Color( 0, 0, 0 ) )
end
end
end 
end 
...
hook.Add("Think", "Speedhacker", Speedhack)
